...
class OssStorage(Storage):
    ...
    def __init__(self, access_key_id=None, access_key_secret=None, end_point=None, cname=None, bucket_name=None, expire_time=None):
    ...
    def url(self, name):
        ...
        # Use cname when sign url
        bucket = self.cname_bucket if self.cname else self.bucket
        str = bucket.sign_url('GET', key, expires=self.expire_time)
